...
resource "aws_iam_openid_connect_provider" "oidc_provider" {
  ...
  thumbprint_list = ["${var.aws_iam_openid_connect_provider}"]
...
locals {
    ...
    #aws_iam_oidc_connect_provider_extract_from_arn = element(split("oidc_provider/", "${aws_iam_openid_connect_provider.oidc_provider.arn}"))
}
